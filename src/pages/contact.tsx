            ...
            <div className="container">
              <form action="/" method="get" id="contact-form">
                ...
                <div>         
                  ...
                  <input type="email" id="email" placeholder="Email - ex: you@email.com"></input>
                </div>
                <div>                
                  <ChatLeftText size={25} className="icone-message"/> 
                  <textarea itemType="text" className="message" id="message" placeholder="Message :)"></textarea>
                </div>
              ...
              <div className="media-and-location-container">
                ...
                <div className="location-container">
                  <h2>Locale</h2>
                  <p>Av. Almeida Garret, 267 - Jardim Nossa Sra. Auxiliadora, Campinas - SP, 13087-290.</p>
                </div>
              </div>
            </div>
          </Div>
